...
using UFIDA.U9.CBO.Pub.Operator.OperatorBListUIModel;

namespace U9.VOB.Cus.HBHDongHui.UIPluginwf
{
    public class OperatorList_UIPlugin : UFSoft.UBF.UI.Custom.ExtendedPartBase
    {
        //UFSoft.UBF.UI.IView.IPart part;
        OperatorBListUIFormWebPart _strongPart;
        ...
        public override void AfterInit(UFSoft.UBF.UI.IView.IPart Part, EventArgs args)
        {
            ...
            _strongPart = Part as OperatorBListUIFormWebPart;
        ...
        private void IssueClick(bool isUnIssue)
        {
            ...
            //if (focused != null)
            long[] selectDepts = _strongPart.Model.Operators.GetSelectedRecordIDs();
